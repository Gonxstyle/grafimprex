<?php
/*Este archivo es parte de childthemeAstra, astra child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function childthemeAstra_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'childthemeAstra_enqueue_child_styles' );
